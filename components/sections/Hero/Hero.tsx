...
export default function Hero() {
  ...
  return (
    <MotionSection
      stagger
      staggerDelay={0.12}
      className="relative flex flex-col gap-10 lg:gap-0 lg:block lg:h-132 pb-16 md:pb-28 pt-8 lg:pt-0"
    >
      ...
      <div className="w-full lg:w-[clamp(400px,52%,763px)] xl:w-190.75 flex flex-col gap-8 lg:gap-0 lg:justify-between lg:h-full relative z-10 transition-all duration-300">
        <div className="w-full xl:w-152 space-y-4 text-left">
          <MotionItem variantType="fadeInUp">
          ...
          <MotionItem
            ...
            className="w-full xl:w-114.25 mx-auto lg:mx-0"
          >
        ...
        <MotionItem
          variantType="fadeInUp"
          className="lg:origin-top-left lg:scale-[0.75] xl:scale-100 lg:w-[133.33%] xl:w-full transition-all duration-300"
        >
      ...
      <div className="relative w-full flex justify-center mt-12 lg:mt-0 lg:absolute lg:top-0 lg:right-0 lg:w-[45%] lg:h-full lg:block">
        <div className="relative w-full max-w-[514px] aspect-514/528">
          <MotionItem
            variantType="scaleUp"
            className="absolute top-[9.5%] left-[40.7%] w-[49.2%] z-20"
          >
            <AgentMiniCard
          ...
          <MotionItem
            variantType="fadeInLeft"
            className="absolute top-0 left-0 w-[48.2%] h-[70%]"
          >
          ...
          <MotionItem
            variantType="fadeInRight"
            className="absolute top-[35.6%] left-[51.7%] w-[48.2%] h-[64.4%] border-2 rounded-[clamp(26px,3vw,40px)] overflow-hidden"
          >
            <Image
              src={Prop1}
              alt="Illustration 3"
